            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h2 class="text-white mt-0">Thank you for your response!</h2>
                        <hr class="divider light my-4" />
                        <p class="text-white-50 mb-4">Your record has successfully saved! We contact you as soon as possible!</p>
                        <a class="btn btn-light btn-xl js-scroll-trigger" href="addContactUsForm.jsp">Click for other response!</a>
						<a class="btn btn-light btn-xl js-scroll-trigger" href="index.jsp">Back!</a>
						<a class="btn btn-light btn-xl js-scroll-trigger" href="viewPreview.jsp">Edit!</a>
