            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h2 class="text-white mt-0">Free to message us!</h2>
                        <hr class="divider light my-4" />
                        <p class="text-white-50 mb-4">To receive updates about exclusive experiences, events, new destinations and more, please enter your details below.</p>
                        <a class="btn btn-light btn-xl js-scroll-trigger" href="addContactUsForm.jsp">Click to continue!</a>
                    </div>
                </div>
            </div>
        </section>
