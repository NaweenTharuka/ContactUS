            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h2 class="text-white mt-0">Sorry Try Again!</h2>
                        <hr class="divider light my-4" />
                        <p class="text-white-50 mb-4">Sorry, an error occurred! Please try again latter!</p>
                        <a class="btn btn-light btn-xl js-scroll-trigger" href="addContactUsForm.jsp">Click for new response!</a>
